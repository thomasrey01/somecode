...
public class DefaultHeartBeatController implements HeartBeatController, HeartBeatInfo {
    ...
    public Task<Void> registerHeartBeat() {
        ...
        return Tasks.call(this.backgroundExecutor, new Callable() { // from class: com.google.firebase.heartbeatinfo.-$$Lambda$DefaultHeartBeatController$UUZPx8hW0V_ozcVKYhdoH5HkTH0
    ...
    public Task<String> getHeartBeatsHeader() {
        ...
        return Tasks.call(this.backgroundExecutor, new Callable() { // from class: com.google.firebase.heartbeatinfo.-$$Lambda$DefaultHeartBeatController$XPAPUc1DSouLxVwtmREviKVUuoA
            @Override // java.util.concurrent.Callable
            public final Object call() {
    ...
    private DefaultHeartBeatController(final Context context, final String str, Set<HeartBeatConsumer> set, Provider<UserAgentPublisher> provider, Executor executor) {
        this(new Provider() { // from class: com.google.firebase.heartbeatinfo.-$$Lambda$DefaultHeartBeatController$e9wvYmF9HQ89hhnXeiCNZyN4iuA
