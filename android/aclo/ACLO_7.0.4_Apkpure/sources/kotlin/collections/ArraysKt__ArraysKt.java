        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m578contentEqualskV0jMPg(((UByteArray) t).m96unboximpl(), ((UByteArray) t2).m96unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m575contentEqualsFGO6Aew(((UShortArray) t).m356unboximpl(), ((UShortArray) t2).m356unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m576contentEqualsKJPZfPQ(((UIntArray) t).m174unboximpl(), ((UIntArray) t2).m174unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m580contentEqualslec5QzE(((ULongArray) t).m252unboximpl(), ((ULongArray) t2).m252unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m592contentToString2csIQuQ(uByteArray != null ? uByteArray.m96unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m596contentToStringd6D3K8(uShortArray != null ? uShortArray.m356unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m595contentToStringXUkPCBk(uIntArray != null ? uIntArray.m174unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m598contentToStringuLth9ew(uLongArray != null ? uLongArray.m252unboximpl() : null));
            } else {
