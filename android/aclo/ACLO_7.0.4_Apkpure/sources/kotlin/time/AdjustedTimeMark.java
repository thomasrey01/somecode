...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1320minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1462minusLRDsOJo(this, j);
    }

    /* renamed from: getAdjustment-UwyO8pc  reason: not valid java name */
    public final long m1322getAdjustmentUwyO8pc() {
    ...
    public long mo1319elapsedNowUwyO8pc() {
        return Duration.m1362minusLRDsOJo(this.mark.mo1319elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1321plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1363plusLRDsOJo(this.adjustment, j), null);
    }
}
