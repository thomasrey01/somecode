    ...
    public final void run() {
        ...
        try {
            ...
            if (job != null && !job.isActive()) {
                ...
                continuation.resumeWith(Result.m12constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core)));
            }
            ...
            handleFatalException(null, Result.m15exceptionOrNullimpl(m12constructorimpl2));
        } catch (Throwable th2) {
            try {
            ...
            handleFatalException(th2, Result.m15exceptionOrNullimpl(m12constructorimpl));
        }
    }
