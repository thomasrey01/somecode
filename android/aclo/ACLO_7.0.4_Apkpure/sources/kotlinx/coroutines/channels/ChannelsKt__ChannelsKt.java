...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        ...
        Object mo1503trySendJP2dKIU = sendChannel.mo1503trySendJP2dKIU(e);
        if (mo1503trySendJP2dKIU instanceof ChannelResult.Failed) {
            ...
            return ((ChannelResult) runBlocking$default).m1520unboximpl();
        }
        Unit unit = (Unit) mo1503trySendJP2dKIU;
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1518isSuccessimpl(sendChannel.mo1503trySendJP2dKIU(e))) {
            return;
        }
