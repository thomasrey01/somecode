...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1524invokeWpGqRn0(((ChannelResult) obj).m1520unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m1524invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m1508boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Object m1520unboximpl = ((ChannelResult) this.L$0).m1520unboximpl();
            Throwable m1512exceptionOrNullimpl = ChannelResult.m1512exceptionOrNullimpl(m1520unboximpl);
            if (m1512exceptionOrNullimpl != null) {
                throw m1512exceptionOrNullimpl;
            }
            Object m1513getOrNullimpl = ChannelResult.m1513getOrNullimpl(m1520unboximpl);
            this.label = 1;
            obj = this.$block.invoke(m1513getOrNullimpl, this);
