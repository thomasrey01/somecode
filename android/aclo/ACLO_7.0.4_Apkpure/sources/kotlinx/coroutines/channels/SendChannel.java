...
public interface SendChannel<E> {
    ...
    Object mo1503trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m1518isSuccessimpl(mo1503trySendJP2dKIU)) {
                return true;
            }
            Throwable m1512exceptionOrNullimpl = ChannelResult.m1512exceptionOrNullimpl(mo1503trySendJP2dKIU);
