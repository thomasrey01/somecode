        ...
        while (true) {
            ...
            if (obj == symbol2) {
                ...
                if (atomicReferenceFieldUpdater2.compareAndSet(this, obj, symbol4)) {
                    ...
                    ((CancellableContinuationImpl) obj).resumeWith(Result.m12constructorimpl(Unit.INSTANCE));
                    return;
                }
            }
        }
    ...
    public final Object awaitPending(Continuation<? super Unit> continuation) {
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || (!(this._state instanceof CancellableContinuationImpl))) {
            ...
            if (!atomicReferenceFieldUpdater.compareAndSet(this, symbol, cancellableContinuationImpl2)) {
                ...
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl2.resumeWith(Result.m12constructorimpl(Unit.INSTANCE));
            }
