        ...
        if (m15exceptionOrNullimpl != null) {
            if (DebugKt.getRECOVER_STACK_TRACES()) {
                ...
                if (cancellableContinuation2 instanceof CoroutineStackFrame) {
                    m15exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(m15exceptionOrNullimpl, (CoroutineStackFrame) cancellableContinuation2);
                }
            }
            obj = new CompletedExceptionally(m15exceptionOrNullimpl, false, 2, null);
        }
        return obj;
    }
