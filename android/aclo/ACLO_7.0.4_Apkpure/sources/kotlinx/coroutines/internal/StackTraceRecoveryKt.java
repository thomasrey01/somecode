...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m12constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        try {
            ...
            obj2 = Result.m12constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.Companion;
            obj2 = Result.m12constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m15exceptionOrNullimpl(obj2) == null) {
            obj3 = obj2;
        }
