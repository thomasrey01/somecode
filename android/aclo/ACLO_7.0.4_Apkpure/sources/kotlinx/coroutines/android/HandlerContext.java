...
public final class HandlerContext extends HandlerDispatcher implements Delay {
    ...
    public void mo1549dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        ...
        if (this.handler.postDelayed(runnable, RangesKt.coerceAtMost(j, (long) DurationKt.MAX_MILLIS))) {
            return new DisposableHandle() { // from class: kotlinx.coroutines.android.-$$Lambda$HandlerContext$-TOZof2GYGCn1P43qXNY1O5Gvm8
                ...
                public final void dispose() {
                    HandlerContext.m1497invokeOnTimeout$lambda3(HandlerContext.this, runnable);
                }
            };
        }
        cancelOnRejection(coroutineContext, runnable);
    ...
    public static final void m1497invokeOnTimeout$lambda3(HandlerContext handlerContext, Runnable runnable) {
    ...
    private final void cancelOnRejection(CoroutineContext coroutineContext, Runnable runnable) {
        ...
        Dispatchers.getIO().mo1549dispatch(coroutineContext, runnable);
    }
    ...
    public void mo1550scheduleResumeAfterDelay(long j, final CancellableContinuation<? super Unit> cancellableContinuation) {
