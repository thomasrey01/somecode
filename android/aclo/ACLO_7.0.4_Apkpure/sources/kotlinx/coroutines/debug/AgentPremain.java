...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m12constructorimpl = Result.m12constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m12constructorimpl = Result.m12constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m18isFailureimpl(m12constructorimpl) ? null : m12constructorimpl;
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.-$$Lambda$AgentPremain$8e1eAWGNJu9vYr96rU9gzKJ_uMQ
                public final void handle(Signal signal) {
                    AgentPremain.m1525installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1525installSignalHandler$lambda1(Signal signal) {
