    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < LongCompanionObject.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1550scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1485delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1486toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1486toDelayMillisLRDsOJo(long j) {
        if (Duration.m1326compareToLRDsOJo(j, Duration.Companion.m1429getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1345getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
