            ...
            if (lockFreeLinkedListNode instanceof LockFreeLinkedListNode) {
                ...
                try {
                    ...
                    if (completionHandlerException2 != null) {
                        ...
                        kotlin.ExceptionsKt.addSuppressed(completionHandlerException3, th2);
                        if (completionHandlerException3 != null) {
                        }
                    }
                    CompletionHandlerException completionHandlerException4 = new CompletionHandlerException("Exception in completion handler " + jobNode + " for " + this, th2);
                    Unit unit = Unit.INSTANCE;
                    completionHandlerException = completionHandlerException4;
                }
            }
        }
        CompletionHandlerException completionHandlerException5 = completionHandlerException;
        if (completionHandlerException5 != null) {
            handleOnCompletionException$kotlinx_coroutines_core(completionHandlerException5);
        }
    }
